...
async function runCompleteRegistrationMigration() {
  try {
    ...
    await pool.query(`ALTER TABLE workers ADD COLUMN IF NOT EXISTS registration_submitted_at TIMESTAMP`);
...
async function startServer() {
  try {
    ...
    `);
    console.log('✅ Added document_type column to certifications');
